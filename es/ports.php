...
?>
	...
	<p>
	Este formulario le permite buscar en el Ìndice actualizado del software de DarwinPorts. <br />
	<i> Ultima acutalizaciÛn del Ìndice: </i>
	<?
	...
	<table>
		<tr>
			...
			<td>
				<select name="by">
				<option value="name"<? if ($by == "name") { echo " selected=\"selected\""; } ?>>TÌtulo del Software</option>
				<option value="desc"<? if ($by == "desc") { echo " selected=\"selected\""; } ?>>DescripciÛn</option>
				<option value="cat"<? if ($by == "cat") { echo " selected=\"selected\""; } ?>>CategorÌa</option>
...
?>
			<td colspan="4" align="left"><a href="<?= $PHP_SELF; ?>?by=all">Ver todos los tÌtulos (<?= $count; ?>)</a></td>
		</tr>
		<?
			if (!$by || (!$substr && $by != "all")) {
		?>
		<tr><td colspan="4"><hr size="1" noshade="noshade" /></td></tr>
		<tr><th colspan="4" align="left">Ver por CategorÌa:</th></tr>
		<?
