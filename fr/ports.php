	...
	<table>
		<tr>
			...
			<td>
				...
				<option value="cat"<? if ($by == "cateogry") { echo " selected=\"selected\""; } ?>>Catégorie</option>
...
?>
		...
		?>
		<tr><td colspan="4"><hr size="1" noshade="noshade" /></td></tr>
		<tr><th colspan="4" align="left">Voir par catégorie :</th></tr>
		<?
...
?>
	<p>
	<i><?= mysql_num_rows($result); ?> Portfile<? if (mysql_num_rows($result) != 1) { echo "s"; } ?> sélectionné(s)</i>
	</p>
	<dl>
<?		
			while( $row = mysql_fetch_assoc($result) ) {
