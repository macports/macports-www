<? // // File : portfileHOWTO.php // Version : $Id: portfileHOWTO.php,v 1.1 2003/01/08 03:46:51 matt Exp $ // Location : /projects/darwinports/portfileHOWTO.php // include_once("$DOCUMENT_ROOT/includes/od_lib.inc.php"); od_print_header("How to Write a DarwinPorts Portfile", "fr", "iso-8859-1", "", 0); ?>
<h2>
...
<ul>
	...
	<li><a href="#extract">Extraction des sources dans le répertoire de travail</a></li>
...
<h3>
	<a name="extract"></a>Extraction des sources dans le répertoire de travail
</h3>
<p>
...
<p>
	Comme Darwin 6.0 a l'ipv6, il est possible de configurer le port avec l'option <tt>--with-ipv6</tt>. Cela peut être effectué en ajoutant l'option suivante dans le Portfile :
</p>
<pre><tt>
