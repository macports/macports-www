  ...
  ?>
	...
	"checkout" del deposito CVS (in gergo repository CVS).</p>

      <p>Nel caso in cui vuoi installare ed eseguire DarwinPorts su Mac OS X 
	prima di tutto assicurati di aver già installato i Mac OS X 
	Developer Tools (per 10.2.x) o XCode (per 10.3.x).</p>
	  ...
	  di conoscenza delle utility per la compilazione come gcc è necessaria):
	  <ul>
	  	<li>TCL (8.3 o 8.4)</li>
		<li>curl</li>
	...
	tramite CVS. C'è anche un <a href="http://darwinports.opendarwin.org/docs/ch01s03.html">
	capitolo</a> nella <a href="http://darwinports.opendarwin.org/docs/">
	Guida a DarwinPorts</a> (attualmente in inglese) che illustra 
	più in dettaglio come installare e come utilizzare DarwinPorts.</p> 
